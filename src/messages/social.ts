...
export const RARE_EVENTS = localize('RARE_EVENTS', [
  ...
  'I counted: you\'ve mass of bracketsped more times than you\'ve pushed',
  'Today\'s mass of brackets: try { love() } finally { always() }',
  'Confession: I watch your git log when you\'re not looking',
  'If this session were a PR, I\'d mass of brackets approve it',
  'You know what\'s underrated? Error messages. They care about you',
  'Hot take: the best debugger is a good night\'s sleep',
  'sudo make me a mass of brackets',
  'I think, therefore I lint',
  '// TODO: tell human they\'re amazing',
]);
